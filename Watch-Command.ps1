...
Modified again by: Travis Logue on 2022-10-01 (changed name to 'Watch-Command')
 
.EXAMPLE 
Watch-Command -Interval 5 -Command 'netstat -an | Select-String :123' 
...
.EXAMPLE 
Watch-Command -Interval 5 -Command 'netstat -an | Select-String SYN' 
 
Every 5s: netstat -an | Select-String SYN Friday, May 19, 2017 10:41:45 AM 
 
TCP 10.111.161.155:59105 172.17.55.13:3333 SYN_SENT 
.EXAMPLE 
Watch-Command -Interval 10 -Command 'Get-ChildItem -Path C:\Logs' 
