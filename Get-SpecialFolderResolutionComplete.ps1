<#
.SYNOPSIS
  The "Get-SpecialFolderResolutionComplete" function leverages a hard-coded mapping of known GUIDs and special folder names, then iterates over each to display the special folder name and the respective resolved path it references. 

.EXAMPLE
  PS C:\> $test = Get-SpecialFolderResolutionComplete
  PS C:\> $test | ft
  ...
  ConflictFolder
  ConnectionsFolder
  Contacts              C:\Users\Jannus.Fugal\Contacts
  ControlPanelFolder
  Cookies               C:\Users\Jannus.Fugal\AppData\Local\Microsoft\Windows\INetCookies
  Desktop               C:\Users\Jannus.Fugal\Desktop
  Documents             C:\Users\Jannus.Fugal\Documents
  Downloads             C:\Users\Jannus.Fugal\Downloads
  Favorites             C:\Users\Jannus.Fugal\Favorites
  Fonts                 C:\WINDOWS\Fonts
  Games
  GameTasks             C:\Users\Jannus.Fugal\AppData\Local\Microsoft\Windows\GameExplorer
  ...
  InternetFolder
  Links                 C:\Users\Jannus.Fugal\Links
  LocalAppData          C:\Users\Jannus.Fugal\AppData\Local
  LocalAppDataLow       C:\Users\Jannus.Fugal\AppData\LocalLow
  LocalizedResourcesDir
  Music                 C:\Users\Jannus.Fugal\Music
  NetHood               C:\Users\Jannus.Fugal\AppData\Roaming\Microsoft\Windows\Network Shortcuts
  NetworkFolder
  OriginalImages
  PhotoAlbums
  Pictures              C:\Users\Jannus.Fugal\Pictures
  Playlists
  PrintersFolder
  PrintHood             C:\Users\Jannus.Fugal\AppData\Roaming\Microsoft\Windows\Printer Shortcuts
  Profile               C:\Users\Jannus.Fugal
  ...
  PublicMusic           C:\Users\Public\Music
  PublicPictures        C:\Users\Public\Pictures
  PublicVideos          C:\Users\Public\Videos
  QuickLaunch           C:\Users\Jannus.Fugal\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch
  Recent                C:\Users\Jannus.Fugal\AppData\Roaming\Microsoft\Windows\Recent
  RecycleBinFolder
  ResourceDir           C:\WINDOWS\resources
  RoamingAppData        C:\Users\Jannus.Fugal\AppData\Roaming
  SampleMusic
  SamplePictures
  SamplePlaylists
  SampleVideos
  SavedGames            C:\Users\Jannus.Fugal\Saved Games
  SavedSearches         C:\Users\Jannus.Fugal\Searches
  SEARCH_CSC
  SEARCH_MAPI
  SearchHome
  ...
  UsersFiles
  Videos                C:\Users\Jannus.Fugal\Videos
  Windows               C:\WINDOWS
...
.NOTES
  Name:  Get-SpecialFolderResolutionComplete.ps1
  Author:  Travis Logue
  Version History:  1.1 | 2021-11-11 | Initial Version
  Dependencies:  
  Notes:
  - I retrieved the primary code from here:  https://stackoverflow.com/questions/25049875/getting-any-special-folder-path-in-powershell-using-folder-guid

  .
#>
function Get-SpecialFolderResolutionComplete {
  [CmdletBinding()]
  param ()
